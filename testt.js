...
const showAll = (products) => {
    ...
    products.forEach((product) => {
      ...
      <p class="text-gray-700 dark:text-gray-200 font-bold mb-2">$${product.price}</p>
      <h2 class="font-semibold text-lg mb-1 dark:text-gray-100">${product.title}</h2>
      <p class="text-gray-500 dark:text-gray-300 text-sm mb-2">${product.description}</p>
      <p class="text-sm font-bold mb-2 dark:text-gray-200">In Stock: ${product.stock}</p>
